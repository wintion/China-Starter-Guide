...
International departments are usually the **more foreigner-friendly part of a larger hospital**.  
...
They are often a good middle path between busy public care and fully private clinics.
...
For foreigners, the biggest advantages are often:
...
## Exact Actions: How to Use Them Well
...
### 2. Compare them with private clinics, not just public outpatient care
...
- **Using them for purely urgent cases where speed matters more than channel selection**
...
- [ ] Compare international department vs private clinic.
